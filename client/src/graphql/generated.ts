...
export type BodyFragment = { __typename?: 'postBody' } & {
    blocks: Array<
        { __typename?: 'contentBlock' } & Pick<
            ContentBlock,
            'depth' | 'key' | 'text' | 'type'
        > & {
                entityRanges: Array<
                    { __typename?: 'entityRange' } & Pick<
                        EntityRange,
                        'key' | 'length' | 'offset'
                    >
                >;
                inlineStyleRanges: Array<
                    { __typename?: 'inlineStyleRange' } & Pick<
                        InlineStyleRange,
                        'length' | 'offset' | 'style'
                    >
                >;
    ...
    >;
    entityMap: Array<
        { __typename?: 'entityMap' } & Pick<
            EntityMap,
            'mutability' | 'type'
        > & { data: { __typename?: 'entityData' } & Pick<EntityData, 'src'> }
    >;
};

export type PostCommentFragment = { __typename?: 'Comment' } & Pick<
    Comment,
    'id' | 'text' | 'createdAt' | 'replyId'
> & {
        user: { __typename?: 'User' } & Pick<User, 'email'>;
        replies: Array<{ __typename?: 'Comment' } & Pick<Comment, 'id'>>;
    };
...
export type PostQuery = { __typename?: 'Query' } & {
    getPost?: Maybe<
        { __typename?: 'Post' } & Pick<Post, 'id' | 'title'> & {
                body: { __typename?: 'postBody' } & BodyFragment;
                comments: Array<
                    { __typename?: 'Comment' } & PostCommentFragment
                >;
            }
    >;
};
...
export type PostsPreviewsQuery = { __typename?: 'Query' } & {
    totalItems: Query['getAmountOfPosts'];
} & {
    postsPreview: Array<
        { __typename?: 'PostPreview' } & Pick<
            PostPreview,
            'bodyPreview' | 'imageSrc' | 'title' | 'id'
        >
    >;
};
...
export type AddPostMutation = { __typename?: 'Mutation' } & {
    addPost: { __typename?: 'Post' } & Pick<Post, 'id' | 'title'> & {
            body: { __typename?: 'postBody' } & BodyFragment;
        };
};
...
export type DeletePostMutation = { __typename?: 'Mutation' } & {
    deletePost: { __typename?: 'ApiResponse' } & Pick<ApiResponse, 'ok'>;
};
...
export type LeaveCommentMutation = { __typename?: 'Mutation' } & {
    leaveComment: { __typename?: 'Comment' } & PostCommentFragment;
};
 ...
 * });
 */
export function usePostsPreviewsQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<
        PostsPreviewsQuery,
        PostsPreviewsQueryVariables
    >
) {
    return ApolloReactHooks.useQuery<
        PostsPreviewsQuery,
        PostsPreviewsQueryVariables
    >(PostsPreviewsDocument, baseOptions);
}
export function usePostsPreviewsLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        PostsPreviewsQuery,
        PostsPreviewsQueryVariables
    >
...
export type PostsPreviewsQueryHookResult = ReturnType<
    typeof usePostsPreviewsQuery
>;
export type PostsPreviewsLazyQueryHookResult = ReturnType<
    typeof usePostsPreviewsLazyQuery
>;
export type PostsPreviewsQueryResult = ApolloReactCommon.QueryResult<
    PostsPreviewsQuery,
    PostsPreviewsQueryVariables
>;
...
export const LeaveCommentDocument = gql`
    ...
    ${PostCommentFragmentDoc}
`;
export type LeaveCommentMutationFn = ApolloReactCommon.MutationFunction<
    LeaveCommentMutation,
    LeaveCommentMutationVariables
>;
 ...
 * });
 */
export function useLeaveCommentMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<
        LeaveCommentMutation,
        LeaveCommentMutationVariables
    >
    ...
    return ApolloReactHooks.useMutation<
        LeaveCommentMutation,
        LeaveCommentMutationVariables
    >(LeaveCommentDocument, baseOptions);
}
export type LeaveCommentMutationHookResult = ReturnType<
    typeof useLeaveCommentMutation
>;
export type LeaveCommentMutationResult = ApolloReactCommon.MutationResult<
    LeaveCommentMutation
>;
export type LeaveCommentMutationOptions = ApolloReactCommon.BaseMutationOptions<
    LeaveCommentMutation,
    LeaveCommentMutationVariables
>;
